...
├── CONTEXT.md
├── docs/adr/
│   ├── 0001-generate-typed-client-from-registry-snapshot.md
│   └── 0002-single-shared-serialized-websocket-client.md
└── internal/
```
...
> _Contradicts ADR-0003 (dataset deletion safety) — but worth reopening because…_
